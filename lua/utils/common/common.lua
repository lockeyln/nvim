...
function common.get_icons(name, fill)
    local icons = require("utils.common.icons")
...
function common.get_all_win_buf_ft()
    local result = {}
...
function common.get_all_float_win()
    local result = {}
    local win_tbl = vim.api.nvim_list_wins()
    for _, win_id in ipairs(win_tbl) do
...
function common.toggle_sidebar(target_ft)
    local offset_ft = {
        "NvimTree",
        "undotree",
        "dbui",
...
function common.terminal_offset_run_command(command)
    local offset_ft = {
    ...
    local all_win_buf_ft = common.get_all_win_buf_ft()
